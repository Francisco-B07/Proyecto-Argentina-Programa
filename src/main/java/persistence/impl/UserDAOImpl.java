...
public class UserDAOImpl implements UserDAO {
	...
	public int insert(User user) {
		try {
			String sql = "INSERT INTO USERS (USERNAME, PASSWORD, ADMIN, COINS, TIME, FAVORITA) VALUES (?, ?, ?, ?, ?, ?)";
			...
			statement.setString(6, user.getTipo().name());
	...
	private User toUser(ResultSet userRegister) throws SQLException {
		return new User(userRegister.getInt(1), userRegister.getString(2), userRegister.getString(3),
				userRegister.getInt(5), userRegister.getDouble(6), userRegister.getBoolean(4), TipoDeAtraccion.valueOf(userRegister.getString(7)), userRegister.getBoolean(8));
	}
